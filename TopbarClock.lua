...
--- Time - TextLabel (AnchorPoint = Vector2.new(.5, .5), BackgroundTransparency = 1, Position = UDim2.new(.5, 0, .5, 0), Size = UDim2.new(.95, 0, .75, 0), Font = Enum.Font.GothamBold, TextColor3 = Color3.fromRGB(255, 255, 255), TextScaled = true, TextStrokeTransparency = 1, TextXAlignment = Enum.TextXAlignment.Right)
